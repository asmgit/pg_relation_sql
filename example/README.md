...
No install needed to try it — the same schema with pre-generated functions lives in a [db&lt;&gt;fiddle sandbox](https://dbfiddle.uk/U95ODCR7); the [test environment](../test/README.md) adds bulk data for plan comparisons.
